...
/**
 * Defines backup_opencast_activity_task class
 *
...
require_once($CFG->dirroot . '/mod/opencast/backup/moodle2/backup_opencast_stepslib.php');
...
class backup_opencast_activity_task extends backup_activity_task {
    ...
    /**
     * Defines a backup step to store the instance data in the opencast.xml file
     */
